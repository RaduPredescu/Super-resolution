...
def write_config_to_tensorboard(
    ...
    config_lines = [
        "# EDSR-lite REDS training configuration",
        "",
        f"device: {device}",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train / fine-tune EDSR-lite on REDS.")
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Optional EDSR-lite checkpoint for transfer learning / fine-tuning.",
    )
